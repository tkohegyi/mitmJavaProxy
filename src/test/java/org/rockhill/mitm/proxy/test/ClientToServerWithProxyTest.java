 ...
 * All tests are WITH using the mitm proxy.
 * http/https * get/put * std server/stub server
 */
public class ClientToServerWithProxyTest extends StubServerBase {
    ...
    public void testSimpleGetRequest() throws Exception {
        try (CloseableHttpClient httpClient = getHttpClient(WITH_PROXY)) {
            ...
            assertEquals(1, defaultResponseInterceptor.getResponseCount());
            assertEquals(1, defaultRequestInterceptor.getRequestCount());
        }
    }
