 ...
 * Represents the life cycle interface for an abstract software component.
 *
...
public interface LifeCycle {
    ...
    /**
     * Stop the LifeCycle.
     * The LifeCycle may wait for current activities to complete normally, but it can be interrupted.
     *
