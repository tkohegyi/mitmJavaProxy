...
public class SocketChannelListener extends ThreadPool implements HttpListener {
    ...
    /* ------------------------------------------------------------------------------- */
    /*
     * @see net.lightbody.bmp.proxy.jetty.http.HttpListener#getHttpServer()
     */
    ...
    /* ------------------------------------------------------------------------------- */
    /*
     * @see net.lightbody.bmp.proxy.jetty.http.HttpListener#setHttpServer(net.lightbody.bmp.proxy.jetty.http.HttpServer)
     */
    ...
    /**
     * @see net.lightbody.bmp.proxy.jetty.http.HttpListener#setHost(java.lang.String)
     */
    ...
    /* ------------------------------------------------------------------------------- */
    /*
     * @see net.lightbody.bmp.proxy.jetty.http.HttpListener#getPort()
     */
    public int getPort() {
        if (_address == null)
            return 0;
    ...
    /* ------------------------------------------------------------------------------- */
    /*
     * @see net.lightbody.bmp.proxy.jetty.http.HttpListener#setPort(int)
     */
    ...
    /* ------------------------------------------------------------------------------- */
    /*
     * @see net.lightbody.bmp.proxy.jetty.http.HttpListener#getBufferSize()
     */
    ...
    /* ------------------------------------------------------------------------------- */
    /*
     * @see net.lightbody.bmp.proxy.jetty.http.HttpListener#getBufferReserve()
     */
    ...
    /* ------------------------------------------------------------------------------- */
    /*
     * @see net.lightbody.bmp.proxy.jetty.http.HttpListener#getDefaultScheme()
     */
    ...
    /* ------------------------------------------------------------------------------- */
    /*
     * @see net.lightbody.bmp.proxy.jetty.http.HttpListener#customizeRequest(net.lightbody.bmp.proxy.jetty.http.HttpConnection, net.lightbody.bmp.proxy.jetty.http.HttpRequest)
     */
    ...
    /* ------------------------------------------------------------------------------- */
    /*
     * @see net.lightbody.bmp.proxy.jetty.http.HttpListener#isLowOnResources()
     */
    ...
    /* ------------------------------------------------------------------------------- */
    /*
     * @see net.lightbody.bmp.proxy.jetty.http.HttpListener#isOutOfResources()
     */
    ...
    /* ------------------------------------------------------------------------------- */
    /*
     * @see net.lightbody.bmp.proxy.jetty.http.HttpListener#getIntegralScheme()
     */
    ...
    /* ------------------------------------------------------------------------------- */
    /*
     * @see net.lightbody.bmp.proxy.jetty.http.HttpListener#getIntegralPort()
     */
    ...
    /* ------------------------------------------------------------------------------- */
    /*
     * @see net.lightbody.bmp.proxy.jetty.http.HttpListener#getConfidentialScheme()
     */
    ...
    /**
     * @see net.lightbody.bmp.proxy.jetty.http.HttpListener#getHttpHandler()
     */
