...
import net.lightbody.bmp.proxy.jetty.util.RolloverFileOutputStream;
import net.lightbody.bmp.proxy.jetty.util.StringBufferWriter;
 ...
 * @see net.lightbody.bmp.proxy.jetty.util.Log
 */
public class OutputStreamLogSink
    ...
    public synchronized void stop() {
        ...
        if (_out != null) {
            try {
                ...
                if (_logImpl != null && _logImpl.getDebug()) e.printStackTrace();
            }
            Thread.yield();
        }
    ...
    /* (non-Javadoc)
     * @see net.lightbody.bmp.proxy.jetty.log.LogSink#setLogImpl(net.lightbody.bmp.proxy.jetty.log.LogImpl)
     */
