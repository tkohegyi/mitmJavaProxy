 ...
 * <p>
 * This class should probably be called HttpConnector, but it's name predates the EventListener API in java.
 * <p>
 * Once a HttpListener is started, it is responsible for listening for new connections. Once a new connection
 * is accepted it should be handled by creating a HttpConnection instance and calling either the HttpConnection.handle()
 * or HttpConnection.handleNext() methods from a Thread allocated to that connection.
 *
