 ...
 * The update() method must be called to check if the real resource has been modified.
 *
...
public class CachedResource extends Resource {
    ...
    public synchronized boolean isUptoDate() {
        return _resource != null && _resource.exists() && _resource.lastModified() == _lastModified;
    }
     ...
     */
    public synchronized boolean renameTo(Resource dest) throws SecurityException {
