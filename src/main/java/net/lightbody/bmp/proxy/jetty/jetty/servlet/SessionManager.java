...
public interface SessionManager extends LifeCycle, Serializable {
    ...
    /**
     * Session cookie name.
     * Defaults to JSESSIONID, but can be set with the org.mortbay.jetty.servlet.SessionCookie system property.
     */
     ...
     */
    public final static String __SessionDomain = "net.lightbody.bmp.proxy.jetty.jetty.servlet.SessionDomain";
    
    /**
     * Session Path.
     * If this property is set as a ServletContext InitParam, then it is used as the path for the session cookie.
     * If it is not set, then the context path is used as the path for the cookie.
     */
    public final static String __SessionPath = "net.lightbody.bmp.proxy.jetty.jetty.servlet.SessionPath";

    /**
     * Session Max Age. If this property is set as a ServletContext InitParam, then it is used as the max age
     * for the session cookie.  If it is not set, then a max age of -1 is used.
     */
    public final static String __MaxAge = "net.lightbody.bmp.proxy.jetty.jetty.servlet.MaxAge";
     ...
     *
     * @param listener An Event Listener. Individual SessionManagers implementations may accept arbitrary listener types,
     *                 but they are expected to at least handle HttpSessionActivationListener, HttpSessionAttributeListener,
