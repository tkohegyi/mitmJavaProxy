...
public class TempByteHolder {
    ...
    public TempByteHolder(byte[] byte_array, int offset, int prefilled_data_size) {
        ...
        if ((offset + prefilled_data_size > _window_size) || (prefilled_data_size < 0))
    ...
    private void createTempFile() throws IOException {
        _tempfilef = File.createTempFile("net.lightbody.bmp.proxy.jetty.util.TempByteHolder-", ".tmp", _temp_directory).getCanonicalFile();
