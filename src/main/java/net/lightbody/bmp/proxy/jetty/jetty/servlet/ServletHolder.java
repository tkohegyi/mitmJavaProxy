 ...
 * Holds the name, params and some state of a javax.servlet.Servlet instance. It implements the ServletConfig interface.
...
public class ServletHolder extends Holder implements Comparable {
     ...
     *                   javax.servlet.include.servlet_path will be set to this path before service is called.
     */
    ...
    /**
     * Link a user role.
     * Translate the role name used by a servlet, to the link name used by the container.
     *
    ...
    /**
     * @param role Role name that is added to UserPrincipal when this servlet is called.
     */
