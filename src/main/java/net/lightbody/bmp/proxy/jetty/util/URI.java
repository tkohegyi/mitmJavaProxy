...
public class URI implements Cloneable {
     ...
     * The string must contain a URI path, but optionaly may contain a scheme, host, port and query string.
     *
    ...
    /**
     * Encode a URI path.
     * This is the same encoding offered by URLEncoder, except that the '/' character is not encoded.
     *
    ...
    /**
     * Strip parameters from a path. Return path up to any semicolon parameters.
     */
     ...
     * All instances of "." and ".." are factored out.  Null is returned if the path tries to .. above it's root.
     *
     * @param path
     * @return path or null.
     */
     ...
     * @param value The value, which may be a multi valued list or String array.
     */
