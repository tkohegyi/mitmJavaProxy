...
import net.lightbody.bmp.proxy.jetty.jetty.servlet.WebApplicationContext.Configuration;
...
public class TagLibConfiguration implements Configuration {
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see net.lightbody.bmp.proxy.jetty.jetty.servlet.WebApplicationContext.Configuration#getWebApplicationContext()
     */
