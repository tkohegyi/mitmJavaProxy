...
public class SimulatedSocketFactory2 implements ConnectionSocketFactory {
    ...
    public SimulatedSocketFactory2(HostNameResolver hostNameResolver, StreamManager streamManager, int requestTimeout) {
        super();
