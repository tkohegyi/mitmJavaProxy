...
import org.rockhill.mitm.jetty.security.RunAsToken;
import org.rockhill.mitm.jetty.server.MultiPartCleanerListener;
...
public class ServletHolder extends Holder<Servlet> implements UserIdentity.Scope, Comparable<ServletHolder>
{
    ...
    /**
     * @see org.rockhill.mitm.jetty.server.UserIdentity.Scope#getContextPath()
     */
    @Override
    ...
    /**
     * @see org.rockhill.mitm.jetty.server.UserIdentity.Scope#getRoleRefMap()
     */
    @Override
    ...
    private MitmJavaProxyHttpRequest runRequestInterceptors(ServletRequest request) {
