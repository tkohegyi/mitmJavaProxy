...
public class ServerConnector extends AbstractNetworkConnector
{
    ...
    {
        return new ServerConnectorManager2(executor, scheduler, selectors);
    }
    ...
    protected class ServerConnectorManager2 extends SelectorManager
    {
        public ServerConnectorManager2(Executor executor, Scheduler scheduler, int selectors)
        {
